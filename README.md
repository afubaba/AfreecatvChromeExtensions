...
--
버전 특성：edge, whale, google-chrome 등 크롬 핵심 유람기 또는 manifest v3를 지원하는 다른 유람기,이전 버전의 모든 기능 지원，채팅방 동결 모드에서 정보 읽기, 내용 읽기 최적화, 화면 효과 최적화, 성능 최적화 증가
--
...
--
버전 특성：edge, whale, google-chrome 등 크롬 핵심 유람기 또는 manifest v3를 지원하는 다른 유람기,로봇 채팅 랜덤으로 LOL 영웅 이름 선택 기능 추가
--
