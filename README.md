...
--
3.1.1-mv3（edge, whale, 구글-chrome 등 크롬 핵심 유람기 또는 manifest v3를 지원하는 다른 유람기）:v1.2-mv2의 업그레이드 버전，로봇 채팅 랜덤으로 LOL 영웅 이름 선택 기능 추가
--
3.2.1-mv3（edge, whale, 구글-chrome 등 크롬 핵심 유람기 또는 manifest v3를 지원하는 다른 유람기）:v2.2-mv2의 업그레이드 버전，로봇 채팅 랜덤으로 LOL 영웅 이름 선택 기능 추가
--
...
--
기능：내장 탄모 힌트, 글씨체 최적화, 설비 디스플레이, 채팅 로봇（테스트 중）, 관리자 도배 기능，인스타그램에 연결된 모든 앨범 열기 지원,
--
숨김 기능: 선명도 조정 디스플레이
--
