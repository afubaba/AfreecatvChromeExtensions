...
--
v3.1.2-mv3온라인 버전:3.1.1-mv3의 업그레이드 버전，이전 버전의 모든 기능 지원，채팅방 동결 모드에서 정보 읽기, 내용 읽기 최적화, 화면 효과 최적화, 성능 최적화 증가
--
v3.2.2-mv3오프라인판:3.2.1-mv3의 업그레이드 버전，이전 버전의 모든 기능 지원，채팅방 동결 모드에서 정보 읽기, 내용 읽기 최적화, 화면 효과 최적화, 성능 최적화 증가
--
